...
narisi_graf(metode_zmag['SUB'], 'palegreen', 'Načini zmage SUB','python_projektna\sub.png')
narisi_graf(metode_zmag['KO/TKO'], 'lightpink', 'Načini zmage KO/TKO', 'python_projektna\ko_tko.png')
